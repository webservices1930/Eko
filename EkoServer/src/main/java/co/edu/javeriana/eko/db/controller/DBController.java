...
public final class DBController {
   ...
   * @param usuario
   */
  public static void actualizarUsuarioCliente(String nombreColeccion, Cliente usuario) {
    MongoDatabase baseDeDatos = clienteMongo.getDatabase(nombreDB);
    MongoCollection<Document> coleccion = baseDeDatos.getCollection(nombreColeccion);

    coleccion.updateOne(
        eq("correo", usuario.getCorreo()), new Document("$set", new Document("usuario", usuario)));
  }
