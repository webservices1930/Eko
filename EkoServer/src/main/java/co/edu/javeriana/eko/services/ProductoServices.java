...
public class ProductoServices implements IProductoService {
    ...
    public void agregarReserva(Reserva nReserva) {
        ...
        Producto producto = buscarProductoPorId(nReserva.getProductoid());
        DBController.modificarCapacidadProductoAñadir(producto);
    ...
    public void cancelarReserva(@WebParam(name = "reserva") Reserva nReserva){
        Document nReservaDoc = Utils.deObjetoReservaADocumento(nReserva);
        Producto producto = buscarProductoPorId(nReserva.getProductoid());
        DBController.modificarCapacidadProductoCancelar(producto);
        DBController.insertarObjeto("reservas", nReservaDoc);
    }
    @Override
