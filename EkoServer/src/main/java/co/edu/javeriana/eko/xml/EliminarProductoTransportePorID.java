...
/**
 * <p>Clase Java para eliminarProductoTransportePorID complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="eliminarProductoTransportePorID">
 *   &lt;complexContent>
...
@XmlType(name = "eliminarProductoTransportePorID", propOrder = {
    "transporteID"
})
public class EliminarProductoTransportePorID {
