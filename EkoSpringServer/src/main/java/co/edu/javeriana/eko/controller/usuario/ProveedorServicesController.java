...
public class ProveedorServicesController {
    ...
    @RequestMapping(value = "/api/usuarios/proveedor", method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = "/api/usuarios/proveedor/correo", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = "/api/usuarios/proveedor", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
